...
GAME_SPRITES = {}
GAME_SOUNDS = {}
PLAYER = 'Gallery/sprites/flappybird1.png'
...
if __name__ == "__main__":
    ...
    # Game sounds
    GAME_SOUNDS['die'] = pygame.mixer.Sound('Gallery/audio/loose.wav')
    GAME_SOUNDS['hit'] = pygame.mixer.Sound('Gallery/audio/Cartoon Boing.wav')
    GAME_SOUNDS['point'] = pygame.mixer.Sound('Gallery/audio/flappypoint.wav')
